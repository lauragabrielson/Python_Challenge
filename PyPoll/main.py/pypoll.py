...
#calculate candidate percentages
 ...
 #print results
    ...
    print("-------------------------")
    print(f'Khan:  {cand1_percent:.3f}%   ({cand1})')
    print(f'Correy:  {cand2_percent:.3f}%   ({cand2})')
    print(f'Li:  {cand3_percent:.3f}%   ({cand3})')
    print(f"O'Tooley:  {cand4_percent:.3f}%   ({cand4})")
    print("-------------------------")
...
#write files
    ...
    f.write("-------------------------")
    f.write(f'Khan:  {cand1_percent:.3f}%   ({cand1})')
    f.write(f'Correy:  {cand2_percent:.3f}%   ({cand2})')
    f.write(f'Li:  {cand2_percent:.3f}%   ({cand2})')
    f.write(f"O'Tooley:  {cand3_percent:.3f}%   ({cand3})")
    f.write("-------------------------")
